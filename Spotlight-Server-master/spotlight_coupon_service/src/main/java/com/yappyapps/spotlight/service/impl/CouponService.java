...
//		if ((couponRepository.findByName(couponReqObj.getName()) != null)) {
...
//		}
		...
		jObj.put(IConstants.COUPON, couponHelper.buildResponseObject(couponEntity));
	...
	public String getAllCoupons() throws ResourceNotFoundException, BusinessException, Exception {
		...
		List<Coupon> couponEntityList = null;
		try {
