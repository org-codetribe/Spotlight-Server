...
/**
 * The GenreServiceApplication class is the main entry point to start the spring boot
 * application.
 * 
...
public class GenreServiceApplication {
	 ...
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(GenreServiceApplication.class);
	...
	public static void main(String[] args) {
		LOGGER.info("-------------------Spotlight Genre Microservice Starting ---------------------");
		SpringApplication.run(GenreServiceApplication.class, args);
		LOGGER.info("-------------------Spotlight Genre Microservice Started ---------------------");
	}
}
