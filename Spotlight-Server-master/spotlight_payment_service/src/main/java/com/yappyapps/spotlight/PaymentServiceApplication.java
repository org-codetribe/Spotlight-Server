...
/**
 * The PaymentServiceApplication class is the main entry point to start the spring boot
 * application.
 * 
...
public class PaymentServiceApplication {
	...
	public static void main(String[] args) {
		LOGGER.info("-------------------Spotlight Payment Microservice Starting ---------------------");
		SpringApplication.run(PaymentServiceApplication.class, args);
		LOGGER.info("-------------------Spotlight Payment Microservice Started ---------------------");
	}
}
