...
public class PaymentController {
	...
	public @ResponseBody String getAccessToken(@RequestParam(value = "viewerId", required = false) String viewerId)
	...
	public @ResponseBody String getTransactionStatus(@PathVariable("transactionId") String transactionId)
			throws InvalidParameterException, ResourceNotFoundException, BusinessException {
