...
/**
 * The AnalyticsServiceApplication class is the main entry point to start the
...
public class AnalyticsServiceApplication {
	 ...
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(AnalyticsServiceApplication.class);
	...
	public static void main(String[] args) {
		LOGGER.info("-------------------Spotlight Analytics Microservice Starting ---------------------");
		SpringApplication.run(AnalyticsServiceApplication.class, args);
		LOGGER.info("-------------------Spotlight Analytics Microservice Started ---------------------");
	}
}
