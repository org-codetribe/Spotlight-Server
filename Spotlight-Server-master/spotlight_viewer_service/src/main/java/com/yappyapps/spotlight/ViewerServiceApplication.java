...
/**
 * The ViewerServiceApplication class is the main entry point to start the spring boot
 * application.
 * 
...
public class ViewerServiceApplication {
	 ...
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(ViewerServiceApplication.class);
	...
	public static void main(String[] args) {
		LOGGER.info("-------------------Spotlight Viewer Microservice Starting ---------------------");
		SpringApplication.run(ViewerServiceApplication.class, args);
		LOGGER.info("-------------------Spotlight Viewer Microservice Started ---------------------");
	}
}
