...
/**
 * The EventServiceApplication class is the main entry point to start the spring boot
 * application.
 * 
...
public class EventServiceApplication {
	 ...
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(EventServiceApplication.class);
	...
	public static void main(String[] args) {
		LOGGER.info("-------------------Spotlight Event Microservice Starting ---------------------");
		SpringApplication.run(EventServiceApplication.class, args);
		LOGGER.info("-------------------Spotlight Event Microservice Started ---------------------");
	}
}
