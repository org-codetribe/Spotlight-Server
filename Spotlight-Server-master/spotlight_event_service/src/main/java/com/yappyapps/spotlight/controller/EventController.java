...
public class EventController {
	...
	public @ResponseBody String createEvent(@RequestParam(value = "request") String requestBody,
	...
	public @ResponseBody String getAllEventsByEventType(@RequestParam(value = "eventTypeId", required = false) String eventTypeId, 
	...
	public @ResponseBody String getAllEventsByEventTypeName(@RequestParam(value = "eventTypeName", required = false) String eventTypeName, 
			@RequestParam(value = "limit", required = false) String limit,
			@RequestParam(value = "offset", required = false) String offset,
			@RequestParam(value = "direction", required = false) String direction,
			@RequestParam(value = "orderBy", required = false) String orderBy)
	...
	@RequestMapping(value = "/id/{eventId}", method = RequestMethod.GET, produces = {
			MediaType.APPLICATION_JSON_VALUE })
	public @ResponseBody String getEventById(@PathVariable("eventId") String eventId, @RequestParam(value = "viewerId", required = false) String viewerId, @RequestHeader(value="Authorization", required=false) String token)
			throws InvalidParameterException, ResourceNotFoundException, BusinessException {
	...
	@RequestMapping(value = "/id/{eventId}/livestreamstate", method = RequestMethod.GET, produces = {
			MediaType.APPLICATION_JSON_VALUE })
	public @ResponseBody String getEventLiveStreamState(@PathVariable("eventId") String eventId)
			throws InvalidParameterException, ResourceNotFoundException, BusinessException {
	...
	@RequestMapping(value = "/name/{eventName}", method = RequestMethod.GET, produces = {
			MediaType.APPLICATION_JSON_VALUE })
	public @ResponseBody String getEventByName(@PathVariable("eventName") String eventName, @RequestHeader(value="Authorization", required=false) String token)
			throws InvalidParameterException, ResourceNotFoundException, BusinessException {
	...
	@RequestMapping(value = "/public", method = RequestMethod.GET, produces = {
			MediaType.APPLICATION_JSON_VALUE })
	public @ResponseBody String getEventsByBroadcasterPublic(@RequestParam(value = "limit", required = false) String limit,
			@RequestParam(value = "offset", required = false) String offset,
			@RequestParam(value = "direction", required = false) String direction,
			@RequestParam(value = "orderBy", required = false) String orderBy,
...
//		utils.isIntegerGreaterThanZero(broadcasterId, "broadcasterId");
	...
	@RequestMapping(value = "/broadcaster/{broadcasterId}", method = RequestMethod.GET, produces = {
			MediaType.APPLICATION_JSON_VALUE })
	public @ResponseBody String getEventsByBroadcaster(@RequestParam(value = "limit", required = false) String limit,
			@RequestParam(value = "offset", required = false) String offset,
			@RequestParam(value = "direction", required = false) String direction,
			@RequestParam(value = "orderBy", required = false) String orderBy,
	...
	@RequestMapping(value = "/public/trending", method = RequestMethod.GET, produces = {
			MediaType.APPLICATION_JSON_VALUE })
	public @ResponseBody String getTrendingEventsByStatus(@RequestParam(value = "limit", required = false) String limit,
			@RequestParam(value = "status", required = false) String status,
			@RequestParam(value = "viewerId", required = false) String viewerId,
			@RequestParam(value = "offset", required = false) String offset,
			@RequestParam(value = "direction", required = false) String direction,
...
//		utils.isEmptyOrNull(broadcasterId, "broadcasterId");
	...
	@RequestMapping(value = "/public/id/{eventId}", method = RequestMethod.GET, produces = {
			MediaType.APPLICATION_JSON_VALUE })
	public @ResponseBody String getEventByIdPublic(
	...
	@RequestMapping(value = "/status/{status}", method = RequestMethod.GET, produces = {
			MediaType.APPLICATION_JSON_VALUE })
	public @ResponseBody String getEventsByStatus(@PathVariable("status") String status,
			@RequestParam(value = "limit", required = false) String limit,
			@RequestParam(value = "offset", required = false) String offset,
			@RequestParam(value = "direction", required = false) String direction,
			@RequestParam(value = "orderBy", required = false) String orderBy)
	...
	@RequestMapping(value = "/update", method = RequestMethod.POST, consumes = { MediaType.MULTIPART_FORM_DATA_VALUE }, produces = {
			MediaType.APPLICATION_JSON_VALUE })
	public @ResponseBody String updateEvent(@RequestPart(value = "request") String requestBody,
			@RequestPart("eventImage") MultipartFile[] eventImage,
			@RequestHeader("Content-Type") String contentType, @RequestHeader(value="Authorization", required=false) String token, RedirectAttributes redirectAttributes)
			throws InvalidParameterException, AlreadyExistException, BusinessException {
	...
	@RequestMapping(value = "/status", method = RequestMethod.PUT, consumes = { MediaType.APPLICATION_JSON_VALUE }, produces = {
			MediaType.APPLICATION_JSON_VALUE })
	public @ResponseBody String updateEventStatus(@RequestBody String requestBody,
	...
	@RequestMapping(value = "/review", method = RequestMethod.PUT, consumes = { MediaType.APPLICATION_JSON_VALUE }, produces = {
			MediaType.APPLICATION_JSON_VALUE })
	public @ResponseBody String reviewEvent(@RequestBody String requestBody,
			@RequestHeader("Content-Type") String contentType, @RequestHeader(value="Authorization", required=false) String token)
			throws InvalidParameterException, AlreadyExistException, BusinessException {
	...
	@RequestMapping(value = "reviews/id/{eventId}", method = RequestMethod.GET, produces = {
			MediaType.APPLICATION_JSON_VALUE })
	public @ResponseBody String getReviewsByEventId(@PathVariable("eventId") String eventId)
			throws InvalidParameterException, ResourceNotFoundException, BusinessException {
	...
	@RequestMapping(value = "/id/{eventId}", method = RequestMethod.DELETE, produces = {
			MediaType.APPLICATION_JSON_VALUE })
	public @ResponseBody String deleteEvent(@PathVariable("eventId") String eventId)
			throws InvalidParameterException, ResourceNotFoundException, BusinessException {
	...
	@RequestMapping(value = "/public/testdate", method = RequestMethod.PUT, consumes = { MediaType.APPLICATION_JSON_VALUE }, produces = {
			MediaType.APPLICATION_JSON_VALUE })
	public @ResponseBody String testDate(@RequestBody String requestBody,
			@RequestHeader("Content-Type") String contentType, @RequestHeader(value="Authorization", required=false) String token)
			throws InvalidParameterException, AlreadyExistException, BusinessException {
