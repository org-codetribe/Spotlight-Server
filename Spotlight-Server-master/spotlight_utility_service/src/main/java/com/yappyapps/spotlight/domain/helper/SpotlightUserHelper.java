...
public class SpotlightUserHelper {
    ...
    public SpotlightUser populateSpotlightUser(SpotlightUser spotlightUserReqObj) {
        ...
        spotlightUserEntity.setProfileUrl(spotlightUserReqObj.getProfileUrl() != null ? spotlightUserReqObj.getProfileUrl() : null);
...
*/
     ...
     *
     * @param spotlightUserReqObj : SpotlightUser
     * @param spotlightUserEntity : SpotlightUser
     * @return SpotlightUser: spotlightUserEntity
     */
     ...
     *
     * @param accessRoleReqSet    : Set&lt;AccessRole&gt;
     * @param spotlightUserEntity : SpotlightUser
     * @return SpotlightUser: spotlightUserEntity
     */
    ...
    public JSONObject buildResponseObject(SpotlightUser spotlightUser) throws JSONException {
        ...
        spotlightUserObj.put("profileImage", spotlightUser.getProfileUrl());
     ...
     * This method is used to build the response object.
     *
     * @param spotlightUserList : List&lt;SpotlightUser&gt;
