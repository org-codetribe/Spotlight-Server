...
/**
 * The NotificationServiceApplication class is the main entry point to start the spring boot
 * application.
 * 
 ...
 * 
 * <h1>@EnableScheduling</h1> provides the scheduling capability to the
 * application.
 * 
...
public class NotificationServiceApplication {
	...
	public static void main(String[] args) {
		LOGGER.info("-------------------Spotlight Notification Microservice Starting ---------------------");
		SpringApplication.run(NotificationServiceApplication.class, args);
		LOGGER.info("-------------------Spotlight Notification Microservice Started ---------------------");
	}
}
