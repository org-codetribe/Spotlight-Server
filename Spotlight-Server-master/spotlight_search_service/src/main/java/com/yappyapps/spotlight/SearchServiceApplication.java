...
/**
 * The SearchServiceApplication class is the main entry point to start the spring boot
 * application.
 * 
...
public class SearchServiceApplication {
	 ...
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(SearchServiceApplication.class);
	...
	public static void main(String[] args) {
		LOGGER.info("-------------------Spotlight Search Microservice Starting ---------------------");
		SpringApplication.run(SearchServiceApplication.class, args);
		LOGGER.info("-------------------Spotlight Search Microservice Started ---------------------");
	}
}
